export const luxuryProductStyle = {
  ...
  title: "font-['Montserrat'] text-3xl font-light tracking-wide mb-2",
  price: "font-['Montserrat'] text-2xl font-light tracking-wide text-gray-900",
  
  // Breadcrumb typography
  breadcrumb: {
    link: "font-['Montserrat'] text-sm font-light tracking-wide text-gray-600 hover:text-gray-900",
    current: "font-['Montserrat'] text-sm font-light tracking-wide text-gray-900"
  },
