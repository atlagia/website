  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        {items.map((item) => (
          <div key={item.id} className="group bg-white rounded-xl border border-gray-100 p-4 shadow-sm hover:shadow-md transition-all duration-200 hover:border-gray-200">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="flex items-center gap-1 bg-gray-50 rounded-lg p-1">
                  <button
                    ...
                    className="w-7 h-7 flex items-center justify-center hover:bg-gray-200 rounded-md disabled:opacity-50 transition-colors"
                ...
                <button
                  ...
                  className="p-1.5 text-red-400 hover:text-red-600 hover:bg-red-50 rounded-md disabled:opacity-50 transition-all duration-200"
                  disabled={isProcessing}
                  title="Remove item"
                >
                  <Trash2 size={16} />
