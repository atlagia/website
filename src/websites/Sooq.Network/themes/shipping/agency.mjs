export default {
    ...
    shadows: {
      ...
      glow: "0 0 20px rgba(71, 90, 255, 0.35)",
      "ai-card": "0 0 25px rgba(71, 90, 255, 0.2)",
    },
    gradients: {
      "ai-primary": "linear-gradient(135deg, hsl(230, 60%, 50%), hsl(280, 80%, 60%))",
      "ai-secondary": "linear-gradient(135deg, hsl(280, 80%, 60%), hsl(200, 85%, 45%))",
      "ai-accent": "linear-gradient(135deg, hsl(230, 60%, 50%), hsl(200, 85%, 45%))",
      "ai-surface": "linear-gradient(180deg, hsl(230, 40%, 98%), hsl(280, 40%, 98%))",
      "ai-dark": "linear-gradient(135deg, hsl(230, 40%, 8%), hsl(280, 40%, 12%))",
    },
    animation: {
