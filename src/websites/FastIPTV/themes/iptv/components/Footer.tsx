    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">FastIPTV</h3>
            <p className="text-gray-400">Premium IPTV streaming with 32,000+ channels and 140,000+ movies in HD & 4K.</p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} FastIPTV. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
