              ...
              <AnimatedContent key={i} direction="up" delay={i * 80} duration={500}>
                <div className="group">
                  <button
                    ...
                    className="w-full text-left bg-white/[0.03] backdrop-blur-xl rounded-xl p-6 border border-white/10 hover:border-purple-500/30 transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="flex-shrink-0">
                        <svg
                          className={`w-6 h-6 text-gray-300 group-hover:text-purple-300 transform transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
